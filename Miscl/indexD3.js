...
console.log("piruz text1 says: ", text1);

var text2 = d3.select("#text2").text();
console.log("Alemi text2 says: ", text2);

// Modify the text of an HTML element
d3.select(".text1").text("Hey, Piruz changed this!");
...
// Create a new element
var li1 = d3.select("ul").append("li");
li1.text("Another......................... new item has been added!");

// Use chaining to create a new element and set its text
var li2 = d3.select("ul").append("li").text("Another new item!");

// Use chaining to create a new element and set its text
var li4 = d3.select("ul").append("li").text("Alemi44444444 new item!");

// Use chaining to create a new element and set its text
var li3 = d3.select("ul").append("li").text("Alemi new item!");
